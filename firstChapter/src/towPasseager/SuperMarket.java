...
public class SuperMarket {
    public static void main(String[] args) {
        ...
        //售出一个商品
        int m1ToSold = 1;
        System.out.println("感谢购买" + m1ToSold + "个" + m1.name + "，商品单价为:" + m1.price +
                ",消费总额为：" + m1.price*m1ToSold + "。");
        m1.count -= m1ToSold;
        System.out.println(m1.id + "剩余库存" + m1.count);

        int m2ToSold = 3;
        System.out.println("感谢购买" + m2ToSold + "个" + m2.name + "，商品单价为:" + m2.price +
                ",消费总额为：" + m2.price*m2ToSold + "。");
        m2.count -= m2ToSold;
